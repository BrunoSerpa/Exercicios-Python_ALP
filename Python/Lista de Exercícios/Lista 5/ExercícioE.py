...
for telefone in telefones:
    ...
    for numero in telefone:
        #Primero e Último número
        if numeroAnterior==10:
...
Na lista acima existem {telEscolhidos} telefones que foram escolhidos!''')